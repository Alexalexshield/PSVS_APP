package ru.mineradio.psvs_app.ui;
...
import ru.mineradio.psvs_app.Constants;
import ru.mineradio.psvs_app.R;
import ru.mineradio.psvs_app.bluetooth.BleAdapterService;
...
//                        PeripheralControlActivity.this.setAlertLevel((int) b[0]);
                        Log.d(Constants.TAG, "Current GATT_CHARACTERISTIC_READ set to: " + byteArrayAsHexString(b));
...
//    }
    ...
    public void onNoise(View view) {
        String json ="{\"command\"}";//"{\"command\":0, \"freq\":1000, \"modulation\":\"ASK\",\"flag_on_air\":1}";

        byte[] al = json.getBytes();
//        al[0] = 5;//(byte) alert_level;
