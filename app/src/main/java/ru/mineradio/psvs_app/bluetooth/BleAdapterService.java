package ru.mineradio.psvs_app.bluetooth;
...
public class BleAdapterService extends Service {
    ...
    public static String LINK_LOSS_SERVICE_UUID = "0000180A-0000-1000-8000-00805F9B34FB";
    ...
    public static String ALERT_LEVEL_CHARACTERISTIC = "0000CDAB-0000-1000-8000-00805F9B34FB";
